...
const GuiaRemision = require("../../models/facturacion/guiaremision");
const DetalleGuia = require("../../models/facturacion/detalleguia");
...
const guiaRemisionBuilder = require("../../services/sunat/xmlBuilders/guiaRemisionBuilder");
...
const pdfGenerator = require("../../services/sunat/pdfGenerator");
